...
import org.debs.kalog.core.preferences.JvmSecureKeyValueStorageFactory
...
actual fun platformModules(): List<Module> {
    return listOf(
        module {
            ...
            single<SecureKeyValueStorageFactory> { JvmSecureKeyValueStorageFactory("org.debs.kalog") }
        },
    )
}
